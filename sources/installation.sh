...
# Description    : This script is part of MassVulScan.sh and MassVulScan4HTB.sh main scripts but it could be launch alone if needed.
#                  It install all the prerequisites needed for running the main scripts.
